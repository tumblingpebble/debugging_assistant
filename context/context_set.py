from typing import Union, List, Any, Optional, Callable, Awaitable, Mapping, AsyncIterator, Tuple
from pydantic import BaseModel
from langchain_core.runnables import Runnable, RunnableConfig

class ContextSet(Runnable):
    keys: Mapping[str, Optional[Union[Runnable, Callable[[Any], Any], Callable[[Any], Awaitable[Any]]]]]
    prefix: str = ''
